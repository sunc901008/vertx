 ...
 * Description :
 */
public class SessoinTest extends AbstractVerticle {
    ...
    public void start() {
        ...
        router.route().handler(SessionHandler.create(LocalSessionStoreHandler.create(vertx).setSessionTicker(5000)).setSessionTimeout(10000));
    ...
    public static void main(String [] args) {
        ...
        vertx.deployVerticle(SessoinTest.class.getName(), res -> System.out.println(res.result()));
    }
